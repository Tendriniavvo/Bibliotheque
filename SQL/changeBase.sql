...
CREATE TABLE Profils_Adherent (
    ...
    quota_jours_pret INT NOT NULL DEFAULT 14,
    quota_reservation_livre INT NOT NULL DEFAULT 2,
    quota_prolongement_pret INT NOT NULL DEFAULT 1,
    jours_penalite INT NOT NULL DEFAULT 7
);
